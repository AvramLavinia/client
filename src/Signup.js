        ...
        <div className='d-flex justify-content-center align-items-center bg-pimary vh-100'>
            <div className='bg-white p-3 rounded w-25'>
                ...
                <div className='mb-3'>
                    ...
                    <div className='mb-3'>
                        <label htmlFor="repeatpassword"><strong> Repeat Password </strong></label>
                        <input type="repeatpassword" placeholder='Repeat Password' className='form-control rounded-0'/>
                    </div>
